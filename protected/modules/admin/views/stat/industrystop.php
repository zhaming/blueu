        ...
        <div class="col-xs-12">
            <div class="col-sm-5 widget-box" style="margin:25px;">
                <div id="stattype" class="widget-header widget-header-flat" style="line-height:38px;">
                    <?php echo Yii::t('admin', 'VStatHotCoupon') . '(<b>TOP' . $topLimit . '</b>)'; ?>
                </div>
                <div class="widget-body">
                    <div id="hotcoupon" class="widget-main"></div>
                </div>
            </div>
            <div class="col-sm-5 widget-box" style="margin:25px;">
                <div id="stattype" class="widget-header widget-header-flat" style="line-height:38px;">
                    <?php echo Yii::t('admin', 'VStatHotStamp') . '(<b>TOP' . $topLimit . '</b>)'; ?>
                </div>
                <div class="widget-body">
                    <div id="hotstamp" class="widget-main"></div>
                </div>
            </div>
        </div>
    </div>
...
$().ready(function(){
    $('#hotcoupon').load('/admin/stat/industrystop?t=3');
    $('#hotstamp').load('/admin/stat/industrystop?t=4');
});
</script>